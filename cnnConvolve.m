...
for imageNum = 1:numImages  
  for featureNum = 1:numFeatures  
    ...
    for channel = 1:3  
      ...
      WT_Cur = WT(featureNum,:);
      WT_curr = WT_Cur((channel-1)*patchDim*patchDim+1:channel*patchDim*patchDim);  
    ...
    convolvedImage = convolvedImage - WT(featureNum,:)*meanPatch + b(featureNum);    
